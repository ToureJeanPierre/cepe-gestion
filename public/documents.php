    ...
    <div class="col-lg-6">
        <div class="card shadow-sm h-100">
            ...
            <div class="card-body d-flex flex-column gap-2">
                ...
                <a href="pdf_liste_candidats_salles.php?examen_id=<?= $examenId ?>" target="_blank" class="doc-link"><i class="bi bi-file-earmark-pdf doc-link-icon"></i> Liste des candidats par salle — ordre alphabétique (PDF)<i class="bi bi-chevron-right doc-link-chevron"></i></a>
                ...
                <a href="pdf_releve_notes.php?examen_id=<?= $examenId ?>&tri=alpha" target="_blank" class="doc-link"><i class="bi bi-file-earmark-pdf doc-link-icon"></i> Relevé de notes — ordre alphabétique (PDF)<i class="bi bi-chevron-right doc-link-chevron"></i></a>
                <a href="pdf_releve_notes.php?examen_id=<?= $examenId ?>&tri=merite" target="_blank" class="doc-link"><i class="bi bi-file-earmark-pdf doc-link-icon"></i> Relevé de notes — ordre du mérite (PDF)<i class="bi bi-chevron-right doc-link-chevron"></i></a>
